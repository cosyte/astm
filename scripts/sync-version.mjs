 ...
 * That is not hypothetical here: `@cosyte/astm@0.0.1` went to the registry on 2026-07-22 exporting
 * `VERSION === "0.0.0"`, and `docs-content/installation.md` tells an installer to print exactly that
 * constant as the install smoke test. The `version` script (which the shared release workflow invokes
 * as `pnpm run version`) runs `changeset version` and then this, so the bump and the constant always
 * land in the same "Version Packages" commit.
 *
