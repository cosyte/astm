...
| **Common**  | _None_                            | Shared vocabulary: the delimiter model, the escape codec, the date value, code-system provenance, the warning registries | `CANONICAL_DELIMITERS`, value types                            |
