...
evidence behind it. Two exclusions are deliberate. A recognized mnemonic before the delimiter raises
nothing, because there the leftmost reading is the conformant one and only the competitor would be
non-conformant. And a delimiter with no escape character two positions past it raises nothing,
because there is no competing alignment. The code therefore fires only on records that already raise
...
a gate-legal profile can be, 108 of 144 were strict-accepted before against 93 now.
